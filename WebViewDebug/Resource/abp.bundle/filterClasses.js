...
Filter.normalize = function(/**String*/ text) /**String*/
{
  ...
  else if (Filter.elemhideRegExp.test(text))
  {
    ...
    // var [t, domain, separator, selector] = /^(.*?)(#\@?#?)(.*)$/.exec(text);
    var domain = result[1];
    var separator = result[2];
...
* @param {Boolean} [matchCase] Defines whether the filter should distinguish between lower and upper case varters
...
RegExpFilter.prototype =
{
 ...
 /**
  * Defines whether the filter should distinguish between lower and upper case varters
  * @type Boolean
  */
 matchCase: false,
 /**
